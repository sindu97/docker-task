        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="flex justify-end gap-2">
                <button type="button" class="btn btn-sm btn-gradient-primary " data-bs-toggle="modal" data-bs-target="#filterModal">
                  Filters
                </button>
                <a href="{{ route('tasks.create') }}" class="btn btn-sm btn-gradient-danger">
                  Add Task
                </a>
                <a href="{{ route('tasks.download') }}" class="btn btn-sm btn-gradient-warning">
                  CSV
                </a>
            </div>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($allTask->priority == 0)
                      <label class="badge badge-primary">Low</label>
                    @elseif($allTask->priority == 1)
                  ...
                  <td>
                   <a href="{{ route('tasks.edit', $allTask->id) }}"><i class="fa fa-edit"></i></a>
                   <span class="ms-3">
                    <a href= "{{ route('tasks.delete', $allTask->id) }}" ><i class="fa fa-trash-o"></i></a></span>
                  </td>
                </tr>
                @empty
                <tr>
            ...
            <form method="GET" action="{{ Route( 'tasks.index' )}}">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="statusFilter" name="status">
                  ...
                  <option value="{{ $item->value }}" >{{ ucfirst(strtolower($item->name)) }}</option>
                  @endforeach
                </select>
              </div>
